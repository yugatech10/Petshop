...
<body>
     <div class="sidenav">
	     <a href="PetRegisterPage.php">Register Pet</a>
		 <a href="ChooseOwner.php">Update Pet Detail</a>
		 <a href="ChooseDelete.php">Delete Pet</a>
...
if(isset ($_SESSION["username"])) //session userid gets value from text field named userid, shown in user.php
{
     ...
     else
        {
	         ...
	         else
	        {
                 ...
                 <tr>
				  ...
				  <form action="EditPage.php" name="EditForm" method="POST">
	...
	echo "No session exists or session has expired. Please log in again <a href='loginPage.php'> here </a>";
}?>
