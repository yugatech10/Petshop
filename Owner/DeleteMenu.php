...
<body>
	 ...
	 <h1 style="text-align:center;">Delete your Pet Detail</h1>
	 <h4 style="text-align:center;">Choose which record you want to delete.</h4>
     ...
     else
        {
	         ...
	         else
	        {
                 ...
                 <tr>
				  ...
				  <form action="DeletePet.php" name="EditForm" method="POST">
